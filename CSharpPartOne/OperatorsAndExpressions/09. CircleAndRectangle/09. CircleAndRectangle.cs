...
class CircleAndRectangle
{
    static void Main()
    {
        ...
        double circlePointX = x - 1; // we subtract 1 because of the given circle coordinates ((1,1),3)

        Console.Write("Y: ");
        double y = double.Parse(Console.ReadLine());
        double circlePointY = y - 1; // we subtract 1 because of the given circle coordinates ((1,1),3)

...
class VariableArguments
{
    static void Main()
    {
        Console.WriteLine("Min: {0}", Min(6, 1, 5, 4, 3));
        Console.WriteLine("Max: {0}", Max(6, 1, 5, 4, 3));
        Console.WriteLine("Average: {0}", Average(6, 1, 5, 4, 3));
        Console.WriteLine("Sum: {0}", Sum(6, 1, 5, 4, 3));
        Console.WriteLine("Product: {0}", Product(6, 1, 5, 4, 3));
    }
